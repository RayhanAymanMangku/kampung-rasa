...
import { CardMenuDisplay } from './MenuModal';
import { IconButton } from '@material-ui/core';
import { CardMenuDisplayNav } from './MenuModal';

export const DisplayMenuModal = ({ setShowListPesanan, selectedOrderId }) => {
                ...
                <div className="modal-container bg-white w-96 md:w-2/3 mx-auto rounded shadow-lg z-50 overflow-y-auto">
                    <div className="modal-content py-4 px-6 ">
                        ...
                        <div className="flex w-full h-auto mt-4">
                            <CardMenuDisplay idPesanan={selectedOrderId} />
                        </div>
                    </div>
                </div>
            </div>
...
export const DisplayMenuModalNav = ({ setShowListMenu }) => {
    ...
    return (
        <>
            <div className="modal fixed w-full h-[100vh] top-0 left-0 flex flex-col items-center justify-center border-none p-6 z-50">
                <div className="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
                <div className="modal-container bg-white w-96 md:w-2/3 mx-auto rounded shadow-lg z-50 overflow-y-auto">
                    <div className="modal-content py-4 px-6 ">
                        <div className="flex justify-between items-center">
                            <p className="text-xl font-bold text-gray-800">Menu Kami</p>
                            <IconButton onClick={handleCloseMenu} className="modal-close cursor-pointer z-50">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
